 ...
 <div id="container" style="height:640px;">
   ...
   <div id="box_centrale">
    <div id="box_text" style="text-align:justify;"><span class="titleBox">Search Engine</span><br>
     ...
     <span class="textBox">I motori di ricerca (es. Google) sono l’applicazione più usata dai Consumatori per formarsi impressioni sui prodotti e servizi prima di decidere per essi ed eventualmente comperarli.Hai una nuova attività e necessiti di maggiore visibilità? Hai già un Sito o Portale Web? Quale termine, però, viene maggiormente utilizzato nelle ricerche?  Con che  frequenza?
...
<!-- AddThis Button END -->
<br><a href="http://www.facebook.com/pages/I-factorybiz/45057166015?ref=ts" target="new"><img src="entity/facebook.gif" border=0 alt="I-factory è su Facebook"></a>
</DIV>
...
<div id="box_formazione">
    <div id="box_text" style="text-align:justify;margin-top:35px;"><span class="titleBoxV">Formazione</span><br>
     ...
     <span class="textBoxG">I-Factory svolge attività di formazione presso enti privati e pubblici per Livelli Base, Intermedi e Avanzati.</span><br>

<html>
<head>
<title>I-Factory :: WebAgency :: Bari (IT) :: Search Engine :: Case History</title>
<meta name="description" content="I-Factory - WebAgency Bari - Posizionamento sui motori di ricerca, marketing on-line"> 
<meta name="keywords" content="web agency bari,web bari,posizionamento sul web,google,blog i-factory,servizi,accessibilità,promozione sito web,skills,i nostri clienti"> 
...
<center>
 ...
 <div id="box_portfolio" class="textBoxG" style="text-align:justify;">
  <P><span class="textBoxG1">
   <P><span class="titleSotBox">Centro Diurno l'Altra Casa</span><br>
   <img src="entity/analytics.jpg">
   <P><img src="entity/altracasa_visite.jpg">
   <P><span class="titleSotBox">Le Spose di Griffe</span><br>
   <img src="entity/bacheca_lespose.jpg">
 </span></P>
 </div> 
<DIV id="rightMiddle" >
 <div id="freccia" align=right><table border=0><tr><td style="padding-right:10px;"><span class="titleSotBox" style="color:#999999;">ANALISI VISITE WEB SITE</span></td><td><img src="entity/freccia_lavori.png" vspace=0 hspace=0 align=right></td></tr></table></div>
 <div id="lastWork" class="textBoxG" style="margin-top:10px;text-align:justify;border:0px;">
  <table width=100%><tr>
   <td align=center style="border:1px solid #aaaaaa;padding:5px;"><a href="case_history.php"><img src="entity/google_case.jpg" border=0 Alt="Case History Google Analytics"></a></td>
  </tr></table>
 </div>
</DIV>  
</div>

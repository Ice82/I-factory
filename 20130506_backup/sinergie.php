<html>
<head>
<title>I-Factory :: WebAgency :: Bari (IT) :: Sinergie :: Collaborazioni della I-Factory</title>
<meta name="description" content="I-Factory - WebAgency Bari - Collaborazioni con altre aziende, costruzione portali web puglia, posizionamento motori di ricerca."> 
<meta name="keywords" content="web agency bari,web bari,posizionamento sul web,sinergie i-factory,servizi,accessibilità,promozione sito web,skills,i nostri clienti"> 
...
<div id="header">
 ...
 <DIV id="menu"><ul> 
  ...
  <li><span class="menuOff">Sinergie</span> |
 ...
 <DIV id="frecce"><ul>
  ...
  <li id="frc_sin_off"><img src="entity/freccia_verde.png">
...
<!-- start #container -->
<center>
 <div id="container" style="height:830px;">
   <div id="box_portfolio" class="textBoxG" style="height:100px;text-align:justify;">
   <P>La nostra caratteristica è sempre stata quella di cercare di sperimentare, di inventare sinergie creative, di presentare valide novità.</>
   <P>Questa nostra filosofia si consolida e si evolve giorno per giorno grazie al nostro lavoro ma soprattutto grazie al lavoro di chi collabora con noi nei piccoli e nei grandi progetti di ogni giorno.</P>
   </div>
   
   
   <div id="box_portfolio" class="textBoxG" style="margin-top:10px;text-align:left;width:720px;">
   <P><b>COLLABORIAMO CON</b><br>
  
   <img src="entity/ivu.jpg" border=0 ALt="IVU :: Interaction Visualization Usability :: Dipartimento di Informatica Bari"><br>
   <span class="textBoxG1">| IVU interaction visualization usability lab |</span><br>
   <span style="color:#996666;font-weight:normal;">multimedia and multimodal human-computer Interaction_visual languages _interaction models_information visualization_visual analytics _usability engineering_end-user development_interfaces of e-learning systems_www interfaces</span><br>
   <a href="http://www.di.uniba.it/~ivu/index.htm" class="textBoxV" target=new><b>http://www.di.uniba.it/~ivu/index.htm</b></a>

   <P><img src="entity/odd.jpg" border=0 ALt="OddEpisodes"><br>
   <span class="textBoxG1">| ODDEP creactivetions |</span><br>
   <span style="color:#996666;font-weight:normal;">graphic_creative design_illustration_marketing ideas_more love and many emotions</span><br>
   <a href="http://www.oddepisodes.com/" class="textBoxV" target=new><b>http://www.oddepisodes.com</b></a>

            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/thinksocial.jpg" alt="Think Social" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 5px" src="images/thinksocial.png" alt="">
                                    <p><span>Cliente:</span> Think Social</p>
                                    <p><span>Tipologia:</span> Agenzia Web Marketing</p>
                                    <p><span>Progetto:</span> Realizzazione sito web</p>
                                    <p><span>Anno:</span> 2012</p><br />
                                    <a href="http://www.thinksocial.it/" title="Think Social" target="_blank"><span>www.thinksocial.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Realizzazione sito web per la promozione dei servizi i-factory per il social network</p>

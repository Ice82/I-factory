            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/epstudio.jpg" alt="Enza Porro Designer" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px" src="images/ep.png" alt="">
                                    <p><span>Cliente:</span>Enza Porro Designer</p>
                                    <p><span>Tipologia:</span> Interior Designer</p>
                                    <p><span>Progetto:</span> costruzione sito web</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.epstudiodesign.it" title="Enza Porro Designer" target="_blank"><span>www.epstudiodesign.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>

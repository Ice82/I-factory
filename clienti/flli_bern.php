            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/bernard.jpg" alt="F.lli Bernard" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px" src="images/fratellibernard.png" alt="">
                                    <p><span>Cliente:</span> F.lli Bernard</p>
                                    <p><span>Tipologia:</span> lavanderia industriale</p>
                                    <p><span>Progetto:</span> Sviluppo sito vetrina</p>
                                    <p><span>Anno:</span> 2008/2012</p><br />
                                    <a href="http://www.fratellibernard.it/" title="F.lli Bernard" target="_blank"><span>www.fratellibernard.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>

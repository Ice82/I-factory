            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/dardabere.jpg" alt="Dardabere Cafe" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: -25px;" src="images/dardabere.png" alt="">
                                    <p><span>Cliente:</span> Dardabere Cafe</p>
                                    <p><span>Tipologia:</span> Bar Caffetteria</p>
                                    <p><span>Progetto:</span> Sviluppo sito web</p>
                                    <p><span>Anno:</span> 2010</p><br />
                                    <a href="http://www.dardabere.it/" title="Dardabere Cafe" target="_blank"><span>www.dardabere.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                   <h2 style="border-bottom: 1px solid #B1C900;">Richieste del cliente</h2>
                                    <p>Realizzazione sito vetrina</p>

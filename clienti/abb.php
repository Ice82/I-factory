            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/abbraccio.jpg" alt="Centro Diurno l'Abbraccio" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px" src="images/abbraccio.png" alt="">
                                    <p><span>Cliente:</span> Centro Diurno l'Abbraccio</p>
                                    <p><span>Tipologia:</span> Centro Diurno per l'Alzheimer</p>
                                    <p><span>Progetto:</span> Sviluppo sito vetrina</p>
                                    <p><span>Anno:</span> 2011</p><br />
                                    <a href="http://www.centrodiurnolabbraccio.it/" title="Centro Diurno l'Abbraccio" target="_blank"><span>www.centrodiurnolabbraccio.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Realizzazione sito web aziendale</p>

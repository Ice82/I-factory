            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/carrieri.jpg" alt="Carrieri" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: -20px;" src="images/carrieri.png" alt="">
                                    <p><span>Cliente:</span> Carrieri</p>
                                    <p><span>Tipologia:</span> vendita all'ingrosso prodotti idro-termici antincendio, trattamento delle acque primarie e climatizzazione.</p>
                                    <p><span>Progetto:</span> Sviluppo Sito dinamico</p>
                                    <p><span>Anno:</span> 2010/2013</p><br />
                                    <a href="http://www.carrieri.it/" title="Carrieri" target="_blank"><span>www.carrieri.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                   <h2 style="border-bottom: 1px solid #B1C900;">Richieste del cliente</h2>
                                    <p>Restyling sito web, con grafica più accattivante e un approccio social, creazione del pannello di controllo per l'inserimento dei contenuti dinamici</p>
                                    <h3>Linguaggio utilizzato</h3>
                                    <p>Database, php, mysql, html, css</p>

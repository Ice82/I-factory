            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/giare.jpg" alt="Ristorante Le Giare" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 13px;" src="images/legiare.png" alt="">
                                    <p><span>Cliente:</span> Ristorante Le Giare</p>
                                    <p><span>Tipologia:</span> Ristorante</p>
                                    <p><span>Progetto:</span> Sviluppo sito web</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.legiareristorante.it/" title="Ristorante Le Giare" target="_blank"><span>www.legiareristorante.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Restyling sito web, gestione con inserimento di news, eventi e offerte </p>
                                    <h3>Linguaggio utilizzato</h3>
                                    <p>Database, mysql, php, html</p>

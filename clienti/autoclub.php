            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/movingcenter.jpg" alt="MovingCenter Autoclub" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px" src="images/movingcenter.png" alt="">
                                    <p><span>Cliente:</span> MovingCenter Autoclub</p>
                                    <p><span>Tipologia:</span> Concessionaria Fiat usato Multibrand</p>
                                    <p><span>Progetto:</span> gestione stock usato</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.movingcenterbari.it/" title="MovingCenter Autoclub" target="_blank"><span>www.movingcenterbari.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Creazione area riservata per la visualizzazione dello stock auto da parte di concessionarie partner</p>                                    

            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/taxinsieme.jpg" alt="TaxInsieme" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: -8px;" src="images/taxi.png" alt="">
                                    <p><span>Cliente:</span> TaxInsieme</p>
                                    <p><span>Tipologia:</span> Prenotazione Taxi</p>
                                    <p><span>Progetto:</span> Portale per la condivisione corse dei taxi</p>
                                    <p><span>Anno:</span> 2012</p><br />
                                    <a href="http://www.taxinsieme.it/" title="TaxInsieme" target="_blank"><span>www.taxinsieme.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                   <h2 style="border-bottom: 1px solid #B1C900;">Richieste del cliente</h2>
                                    <p>Realizzazione di un portale web gestione crediti degli utenti. Costruzione delle api per il collegamento tra sito e smartphone</p>
                                    <h3>Linguaggio utilizzato</h3>
                                    <p>Database, mysql, php, xml, html5, css</p>

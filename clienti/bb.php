            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/uascezze.jpg" alt="La Uascezze" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 15px;" src="images/uascezze.png" alt="">
                                    <p><span>Cliente:</span> Bed & Breakfast La Uascezze</p>
                                    <p><span>Tipologia:</span> Bed & Breakfast</p>
                                    <p><span>Progetto:</span> Sviluppo sito web</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.oldbari.it/" title="La Uascezze" target="_blank"><span>www.oldbari.it/</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                   <h2 style="border-bottom: 1px solid #B1C900;">Richieste del cliente</h2>
                                    <p>Restyling sito web con possibilità di prenotazione online</p>

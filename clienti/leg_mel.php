            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/melica.jpg" alt="Studio Legale Melica" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: -25px;" src="images/mel.png" alt="">
                                    <p><span>Cliente:</span> Studio Legale Melica</p>
                                    <p><span>Tipologia:</span> Studio Legale</p>
                                    <p><span>Progetto:</span> Sviluppo sito vetrina</p>
                                    <p><span>Anno:</span> 2012</p><br />
                                    <a href="http://www.melica.it/" title="Studio Legale Melica" target="_blank"><span>www.melica.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>

            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/myteacup.jpg" alt="iGuarantee Group" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 15px;" src="images/myteacup.png" alt="">
                                    <p><span>Cliente:</span> My tea cup</p>
                                    <p><span>Tipologia:</span> E-commerce</p>
                                    <p><span>Progetto:</span> Sviluppo sito e-commerce</p>
                                    <p><span>Anno:</span> 2012</p><br />
                                    <a href="http://shop.myteacup.it/" title="My tea cup" target="_blank"><span>shop.myteacup.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                   <h2 style="border-bottom: 1px solid #B1C900;">Richieste del cliente</h2>
                                    <p>Realizzazione di un portale e-commerce con nuove caratteristiche</p>

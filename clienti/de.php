            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/diamantenergy.jpg" alt="Diamante Energy" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px" src="images/diamantenergy.png" alt="">
                                    <p><span>Cliente:</span> Diamante Energy</p>
                                    <p><span>Tipologia:</span> Azienda che punta alla produzione di energie rinnovabili per lo sviluppo sostenibile</p>
                                    <p><span>Progetto:</span> Costruzione sito web</p>
                                    <p><span>Anno:</span> 2012</p><br />
                                    <a href="http://www.diamantenergy.com/" title="Diamante Energy" target="_blank"><span>www.diamantenergy.com/</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Sviluppo di un portale web per la sponsorizzazione dell'attività aziendale<br />
                                    Creazione di un'aria riservata per la visualizzazione di documenti da parte di utenti registrati</p>

            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/groupon.jpg" alt="Groupon" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: -10px;" src="images/groupon.png" alt="">
                                    <p><span>Cliente:</span> Groupon</p>
                                    <p><span>Tipologia:</span> Vendita coupon online</p>
                                    <p><span>Progetto:</span> Sviluppo tool</p>
                                    <p><span>Anno:</span> 2011 ad oggi</p><br />
                                    <a href="http://contactus.groupon.it/" title="Groupon" target="_blank"><span>contactus.groupon.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Costruzione per Italia, Spagna e Portogallo:<br /><br />
                                    - creazione software di business intelligence per l'analisi preview and refund;<br />
                                    - costruzione della pagina contactus.groupon.it per la gestione del customer care;<br />
                                    - creazione tool logistica per l'invio delle liste acquisti ai partner,reportistica magazzino, reposrtistica spedizioni (spedizioni.groupon.it);<br />
                                    - creazione di un tool per usufruire del diritto di recesso, gestione delle richieste (cancelmycoupon.groupon.it);<br />
                                    - costruzione di un tool per invio di fatture a partners;<br />
                                    - costruzione di un collegamento tra software gestionale e crm zendesk attraverso le api zendesk;<br />
                                    - costruzione di pagine per il marketing inside e outside;<br />
                                    - manutenzione dei server su piattaforma Linux;<br />
                                    - sviluppo di tool vari necessari per l'attività aziendale nei 3 paesi;<br />
                                    </p>
                                    <h3>Linguaggio utilizzato</h3>
                                    <p>php,mysql,ajax, html, css, api</p>

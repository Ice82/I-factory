...
/* Setting SEO */
$title_tag = "iGuarantee Group | I-factory | Internet Solutions";
            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/iguarantee.jpg" alt="iGuarantee Group" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 15px;" src="images/iguarantee.png" alt="">
                                    <p><span>Cliente:</span> iGuarantee Group</p>
                                    <p><span>Tipologia:</span> Garanzie auto online</p>
                                    <p><span>Progetto:</span> Creazione di un portale per la commercializzazione di garanzie</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.iguarantee.it/" title="I Guarantee Group" target="_blank"><span>www.iguarantee.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Costruzione di un portale dinamico per la vendita di garanzie auto e non, possibilità da parte di concessionarie partner di attivare le garanzie direttamente online in modo tale da velocizzare il procedimento</p>
                                    <h3>Linguaggio utilizzato</h3>
                                    <p>mysql, php, thml, css, ajax</p>

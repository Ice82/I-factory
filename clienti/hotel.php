            ...
            <div class="container ">
                ...
                <section id="page">
                    <ul class="flexy-gird flexy-gird-one" id="top-image">
                        <li style="border: 1px solid #DDD"><img src="images/slider/rondo.jpg" alt="iGuarantee Group" border="0" /></li>
                    </ul>
                    <div class="clr"></div>
                    ...
                    <ul class="flexy-gird flexy-gird-two">
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    <img class="clients-img" style="height: 100px; margin-top: 15px;" src="images/rondo.png" alt="">
                                    <p><span>Cliente:</span> Rond&ograve; Hotel</p>
                                    <p><span>Tipologia:</span> Hotel</p>
                                    <p><span>Progetto:</span> Restyling sito web</p>
                                    <p><span>Anno:</span> 2013</p><br />
                                    <a href="http://www.rondohotel.it" title="Rond&ograve; Hotel" target="_blank"><span>www.rondohotel.it</span></a>
                                </article>
                            </div>
                        </li>
                        <li>
                            <div class="flexy-gird-container">
                                <article>
                                    ...
                                    <p>Restyling sito web, possibilità di prenotazione e pagamento online, gestione con inserimento di news, eventi e offerte, gestione pagine su social network</p>
